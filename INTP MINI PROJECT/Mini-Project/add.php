...
if ($demail == $email){
  echo"<p style='margin-top:150px;color:green;text-align:center;'>Sorry this $email is already registered!! please <a style='color:green' href='adduser.php'>register again</a> with different email.</p>";  
  $conn->close();
  exit(0);
}
...
if($conn->query($sql)===TRUE){
    echo"<p style='margin-top:150px;color:green;text-align:center;'>New record created successfully.</p>
    ";
}else{    
    echo"<p style='margin-top:150px;color:green;text-align:center;'>Sorry $uname is already taken!! please <a style='color:green' href='adduser.php'>register again</a> with different username</p>";
}
