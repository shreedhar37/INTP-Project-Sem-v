...
<form id='register' name='reg' action='delete.php' class='input_group' method='POST' onsubmit='return deleteUser()'>
...
<button type='submit' class='submit_btn' name='delete' >Delete </button>
</form>
</div>
";
?>
