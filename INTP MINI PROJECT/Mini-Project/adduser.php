...
<form id='register' name='reg' action='add.php' class='input_group' method='POST' onsubmit='return validateReg()'>
...
<button type='submit' class='submit_btn' name='add'>Add</button>
</form>
</div>
";
?>
